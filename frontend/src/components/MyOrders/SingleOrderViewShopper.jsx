...
import {Accordion, AccordionDetails, AccordionSummary, Modal, Paper, Typography} from "@mui/material";
...
export function SingleOrderViewShopper({order, orderName}) {
    ...
    return <>
        ...
        />
        <ReceiptUploadModal open={uploadOpen} onClose={() => setUploadOpen(false)}/>
    </>
}

function ReceiptUploadModal({open, onClose}) {
